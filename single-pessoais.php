...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    ...
    <section class="section__banner__forms">
        <div class="content__banner">
			<div class="image__banner" style="background: url('<?php the_field('banner_imagem_pessoais'); ?>') center no-repeat; background-size:cover;height:343px;width:100%;">
                <h1><?php the_field('texto_banner_pessoais'); ?></h1>
                <h3><?php the_field('sub_texto_banner_pessoais'); ?></h3>
            </div>

            <div class="image__banner__mobile" style="background: url('<?php the_field('banner_imagem_pessoais__mobile'); ?>') center no-repeat; background-size:cover;height:343px;width:100%;">
                <h1><?php the_field('texto_banner_pessoais'); ?></h1>
                <h3><?php the_field('sub_texto_banner_pessoais'); ?></h3>
            </div>

			<a href="/solucoes-pessoais" class="btn__before">
				<i class="ico-arrow-left"></i> Soluções pessoais
			</a>
		</div>
    </section>
